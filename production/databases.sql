...
--
-- Host: localhost
-- Erstellungszeit: 09. Aug 2017 um 09:44
...
CREATE TABLE `parties` (
  ...
  `Spieler1` varchar(255) NOT NULL DEFAULT '0',
  `Spieler2` varchar(255) NOT NULL DEFAULT '0',
...
(1, 'user1', 23, 'andi', 'user1@test.de', '$2y$10$4cYXumNYwx4wx3lIGjWOyu/Wp3vZ5qD56kmfefdYw.f6hsTEAlT16', 23, 'apache helicopter', '6c0b53518762e60b5efcd6bf5f7c6fd6', 1),
(2, 'user2', 0, 'steffi', 'user2@test.de', '$2y$10$N4WNwRzeN2hH8gw3wCsUrOYWq9kRepQ7yKgt96Po9rPVMkhAAMPb6', 20, 'female', '00e7d046fec04389e025539017099573', 1);
...
--
ALTER TABLE `avatars`
  MODIFY `avatarid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT für Tabelle `parties`
--
ALTER TABLE `parties`
  MODIFY `SpielID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
--
